...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-medium max-w-prose !leading-[1.5] sm:text-4xl"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">Hello, I'm Mahmoud.</span> I'm a freelance{" "}
        <span className="font-bold whitespace-nowrap">Front-End developer</span>{" "}
        I enjoy building <span className="italic">sites & apps</span>. My focus
        is <span className="underline">React (Next.js)</span>.
      </motion.h1>

      <motion.div
        className="flex flex-col sm:flex-row items-center justify-center gap-x-3 gap-y-2 px-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/mahmoud-elsayed-9b1027267/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Maahmoud-Elsayed"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
