...
export const projectsData = [
  {
    title: "Yummy",
    description:
      "An online food ordering app built with the T3 Stack, featuring authentication and payment integration. It includes a robust admin panel for managing users, orders, categories, and products.",
    tags: [
      "Next.js",
      "Typescript",
      "TRPC",
